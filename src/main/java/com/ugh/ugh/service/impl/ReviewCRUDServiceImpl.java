...
public class ReviewCRUDServiceImpl implements IReviewCRUDService {
	...
	public void create(String title, int rating, String description, long userId, Long gameId) throws Exception {
		if (title == null || title.isEmpty() 
				...
				|| userId <= 0 || gameId <= 0) throw new Exception ("One or more of the input fields are incorrect or empty");
	...
	@Override
	public void updateById(long id, String title, int rating, String description, long userId, Long gameId) throws Exception {
